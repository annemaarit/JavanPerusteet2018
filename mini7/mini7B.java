...
abstract class Elain{
	...
	//vaihtaa eläimen tilan eläväksi
	public void herataHenkiin(){
		elossa=true;
	}
	
	//jokainen eläin puhuu mutta omalla tavallaan joten
	//toteutus alaluokissa
...
class Kissa extends Elain {
	...
	//merkitsee kissan kuolleeksi, ylikirjoittaa yliluokan metodin
	public void merkitseKuolleeksi(){
		elossa=false;
		elamatKpl=0;				//nollataan kissan elämät
	}
	
	//vaihtaa kissan tilan eläväksi, ylikirjoittaa yliluokan metodin
	public void herataHenkiin(){
		elossa=true;
		elamatKpl=7;
	}
	...
	//tulostaa kissan puheen, jos kissa elossa
	public void puhu(){
		if (elossa)
			System.out.println("Kissa "+nimi+": Miu Mau!");
		else
			System.out.println("Kuolleet eiv\u00E4t puhu.");
	}
}
...
class Papukaija extends Elain{
	...
	//tulostaa papukaijan puheen, jos papukaija on elossa
	public void puhu(){
		if (elossa)
			System.out.println("Papukaija "+nimi+": Kraak, Tahtoo keksin, Kraak!");
		else
			System.out.println("Kuolleet eiv\u00E4t puhu.");
	}
}
...
class Lammas extends Elain{
	...
	//tulostaa lampaan puheen, jos lammas elossa
	public void puhu(){
		if (elossa)
			System.out.println("Lammas "+nimi+": B\u00E4\u00E4 B\u00E4\u00E4\u00E4\u00E4\u00E4!");
		else
			System.out.println("Kuolleet eiv\u00E4t puhu.");
	}
}
...
public class  mini7B{
   ...
   public static void main (String [ ] args) {
	  ...
	  testaaElain(kissa1,"Viiru");		//Default: Eläimen nimi on Miisu. Eläimen nimi on Viiru. Viiru on elossa
	  ...
	  testaaElain(kaija1,"Polli");		//Default: Eläimen nimi on Rilli. Eläimen nimi on Polli. Polli on elossa.
	  ...
	  testaaElain(lammas1,"Pumpuli");	//Default: Eläimen nimi on Päkä. Eläimen nimi on Pumpuli. Pumpuli on elossa.
	  ...
	  //abstraktin yliluokan tyyppinen elain -taulukko
	  Elain elaimet[]={kissa1,kaija1,lammas1};
	  int i;
	  
	  //testataan puhetta
	  System.out.println("\nTestataan el\u00E4inten puhetta:");
	  for (i=0;i<3;i++)
		  elaimet[i].puhu();			//Default: Kuolleet eivät puhu. x 3
	  
	  //herätetään eläimet henkiin
	  System.out.println("\nHer\u00E4tet\u00E4\u00E4n el\u00E4imet henkiin");
	  for (i=0;i<3;i++)
		  elaimet[i].herataHenkiin();

	  //testataan puhetta
	  System.out.println("\nTestataan el\u00E4inten puhetta:");
	  for (i=0;i<3;i++)
		  elaimet[i].puhu();	  		//Default: Kissa Viiru: Miu Mau! Papukaija Polli: Kraak, Tahtoo keksin, Kraak! Lammas Pumpuli: Bää Bäääää!
	}
	
	//testaa Elain -luokan metodeja
	public static void testaaElain(Elain elain, String uusiNimi){
		elain.kerroNimi();
		elain.vaihdaNimi(uusiNimi);
		elain.kerroNimi();
		elain.onkoElossa();
	}
